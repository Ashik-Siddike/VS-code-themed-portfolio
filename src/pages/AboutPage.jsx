...
const AboutPage = () => {
  ...
  return (
    <div className="content-section animate-fade-in" style={{ paddingTop: '2.5rem' }}>
      ...
      {/* Code-style header block */}
      <div className="reveal" style={{ marginBottom: '2rem', fontFamily: 'JetBrains Mono, monospace', fontSize: '12px', lineHeight: 1.9, background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '5px', padding: '16px 20px' }}>
        <div style={{ color: 'var(--gcm)', marginBottom: '4px' }}>{'// about.md — Ashik Siddike'}</div>
      ...
      <div className="reveal" style={{ marginBottom: '2.5rem' }}>
        ...
        <div style={{ color: 'var(--text)', lineHeight: 1.9, fontSize: '13px', maxWidth: '760px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <p>
      ...
      <div className="reveal">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(210px, 1fr))', gap: '12px', maxWidth: '760px' }}>
          {[
            ...
            <div key={title}
              style={{ padding: '14px 16px', background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '5px', transition: 'border-color 0.2s, background 0.2s', cursor: 'default' }}
            ...
            >
              ...
              <div style={{ fontSize: '12px', fontWeight: 600, color: 'var(--bright)', marginBottom: '4px' }}>{title}</div>
              <div style={{ fontSize: '11px', color: 'var(--dim)', lineHeight: 1.6 }}>{desc}</div>
            </div>
          ))}
        </div>
      </div>
