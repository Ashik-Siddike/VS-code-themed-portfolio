...
const FALLBACK_PROJECTS = [
  ...
  {
    title: 'IntervueAI — AI-Powered Mock Interviewer',
    desc: 'A premium SaaS platform that analyzes uploaded PDF resumes, generates tailored coding and behavioral questions, conducts an interactive mock interview, and grades performance with real-time scoring using Google Gemini API.',
    tech: ['Next.js', 'TypeScript', 'Gemini API', 'Tailwind CSS', 'Supabase'],
    accent: '#06b6d4',
    github: 'https://github.com/Ashik-Siddike/AI-Resume-Analyzer-Mock-Interviewer',
    live: 'https://intervueai.ashiksiddike.com',
    featured: true,
  },
  {
    title: '247School (Web-Based Learning Platform)',
    desc: 'A comprehensive educational platform designed to facilitate online learning and school management. Features responsive learning interfaces, interactive student/teacher portals, and robust Firebase database integration.',
    tech: ['TypeScript', 'React.js', 'Tailwind CSS', 'Firebase'],
    accent: '#c586c0',
    github: 'https://github.com/Ashik-Siddike/247-School',
    live: 'https://247school.org',
    featured: true,
  },
  {
